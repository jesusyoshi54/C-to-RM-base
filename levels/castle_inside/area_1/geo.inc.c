...
const GeoLayout castle_inside_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -2800, 0, castle_inside_dl_death_plane_a_0_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_start_plane_a_0_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
