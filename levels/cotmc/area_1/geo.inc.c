...
const GeoLayout cotmc_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -2800, 0, cotmc_dl_death_plane_a_0_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, cotmc_dl_start_plane_a_0_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
