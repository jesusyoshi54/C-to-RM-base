...
#define WARP_OP_SHRINK_ENTER  0x02
...
#define WARP_NODE_ENTRANCE 0x0A
#define WARP_NODE_RESTART 0x0B
#define WARP_NODE_REVIVE 0x0C
#define WARP_NODE_NEXT_AREA 0x1A
#define WARP_NODE_PREV_AREA 0x1B
#define WARP_NODE_SUCCESS 0xF0
#define WARP_NODE_F0 0xF0 //backwards compat
#define WARP_NODE_DEATH 0xF1
#define WARP_NODE_LOOK_UP 0xF2
#define WARP_NODE_WARP_FLOOR 0xF3 //death floor
