...
extern u8 _buffersSegmentNoloadStart[];
extern u8 _buffersSegmentNoloadEnd[];
...
s32 ramP[5][2] = {
    {(u32)&_buffersSegmentNoloadStart,      (u32)&_buffersSegmentNoloadEnd},
    {(u32)&_mainSegmentStart,            (u32)&_mainSegmentEnd},
    {(u32)&_engineSegmentStart,          (u32)&_engineSegmentEnd},
    {(u32)&_framebuffersSegmentNoloadStart, (u32)&_framebuffersSegmentNoloadEnd},
...
void append_puppyprint_log(char *str, ...) {
    s32 i;
    char textBytes[255];
